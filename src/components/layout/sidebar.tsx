...
export function Sidebar() {
  ...
  const isActive = (href: string) => {
    if (href === '/tasks' && (pathname === '/' || pathname === '/tasks'))
      return true
    if (href === '/settings/gtm' && pathname.startsWith('/settings'))
      return true
  ...
  return (
    <>
      <motion.aside
        ...
        className="relative bg-background border-r border-border flex flex-col h-screen"
      >
        {/* Logo Section */}
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full h-9 pl-9 pr-10 text-sm border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent"
                />
                {!searchQuery && (
